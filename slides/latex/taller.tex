...
\begin{document}
    ...
    \begin{frame}{¿Dónde se guardan los datos?}
        \begin{itemize}
            \item \textbf{Archivos locales} — CSV, Excel (lo que usaremos hoy)
            \item \textbf{Hojas de cálculo en la nube} — Google Sheets
            \item \textbf{Bases de datos} — SQL, servicios en la nube
        \end{itemize}
    \end{frame}
