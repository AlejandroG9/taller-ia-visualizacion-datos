...
\begin{document}
    ...
    \begin{frame}{¿Qué es un “harness” o CLI agentic?}
        El programa que conecta un modelo de lenguaje con tu computadora,
        para que pueda leer, escribir y ejecutar código por ti.
        \begin{itemize}
            \item \textbf{Claude Code}, \textbf{Gemini CLI} — los que usaremos hoy
            \item Existen otros (Cursor, GitHub Copilot, entre otros)
        \end{itemize}
    \end{frame}
